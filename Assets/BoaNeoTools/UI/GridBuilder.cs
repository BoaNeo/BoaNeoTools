...
namespace BoaNeoTools.UI
{
	...
	public class GridBuilder : GridCell
	{
		...
		public float maxLayoutHeight { get; set; } = float.MaxValue;
		public float maxLayoutWidth { get; set; } = float.MaxValue;
		...
		public int count => _childCounter;
		public GridCell GetCell(int idx) => _currentChildren[idx];
		...
		public T AddRow<T>(T prefab, Action<T> setup = null) where T : GridCell
		{
